...
if (isset($_FILES['thumb'])) {
    ...
    if ($error_img === 0){
        ...
        $img_upload_path = '../images/songs/'.$new_img_name;
        $img_real_path = 'images/songs/'.$new_img_name;
...
if (isset($_FILES['song'])) {
    ...
    if ($error_song === 0){
        ...
        $song_upload_path = '../music/'.$new_song_name;
        $song_real_path = 'music/'.$new_song_name;
        // echo"$img_upload_path";
