...
if (isset($_FILES['thumb'])) {
    ...
    if ($error_img === 0){
        ...
        $img_upload_path = '../images/study/'.$new_img_name;
        $img_real_path = 'images/study/'.$new_img_name;
...
if (isset($_FILES['song'])) {
    ...
    if ($error_song === 0){
        ...
        $song_upload_path = '../music/study/'.$new_song_name;
        $song_real_path = 'music/study/'.$new_song_name;
        // echo"$img_upload_path";
...
$sql = "INSERT INTO `lofi`(`name`, `thumb`, `song`, `artist`) VALUES ('$name','$img_real_path','$song_real_path','$artist');";
$conn->query($sql);
